...
>
 ...
 <h2>Hello ${option.name}</h2>
    <p>A request has been received to add you as ${option.role === "Admin" ? "an" : "a"} <strong>${
      option.role
    }</strong> in <span style="text-transform: capitalize;"><strong>${option.cname}</strong></span>  company. </p>
